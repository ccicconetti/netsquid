...
class SwapProtocol(NodeProtocol):
    ...
    class CorrectionMessage:
        """Message generated by the swap nodes.

        The message is sent to one of the parties of an end-to-end entanglement
        to perform corrections on its qubit.

        Parameters
        ----------
        m0 : {0 ,1}
            The Z-gate correction factor.
        m1 : {0, 1}
            The X-gate correction factor.
        src : str
            The name of the swap node that generated this message.
        dst : str
